...
- `cz-cli task execute [OPTIONS] TASK_NAME_OR_ID` - [Notice: SIDE EFFECT] Run one temporary execution immediately without publishing to schedule. Requires explicit user approval before use. Use for ad-hoc or validation runs only.

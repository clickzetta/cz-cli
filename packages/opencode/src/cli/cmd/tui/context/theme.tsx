...
import czcode from "./theme/czcode.json" with { type: "json" }
  ...
  init: (props: { mode: "dark" | "light" }) => {
    ...
    setStore(
      produce((draft) => {
        ...
        draft.lock = lock
        const active = config.theme ?? kv.get("theme", "czcode")
        draft.active = typeof active === "string" ? active : "czcode"
        draft.ready = false
      }),
    )

...
const disableDefault = process.env.CLICKZETTA_DISABLE_DEFAULT_PLUGINS
process.env.CLICKZETTA_DISABLE_DEFAULT_PLUGINS = "1"
...
afterAll(() => {
  if (disableDefault === undefined) {
    delete process.env.CLICKZETTA_DISABLE_DEFAULT_PLUGINS
    return
  }
  process.env.CLICKZETTA_DISABLE_DEFAULT_PLUGINS = disableDefault
})

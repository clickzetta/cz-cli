...
export const agentGatewayHelpCases: HelpCase[] = [
  ...
  },
  {
    ...
    expectOptions: ["--path", "--table", "--domain-ids"],
    expectCommands: [
      "Examples:",
      "cz-cli analytics-agent datasource load 603 --workspace datagpt_ws --schema",
      "retail --table-name orders --domain-ids '[5]'",
      "cz-cli analytics-agent datasource load 603 --workspace datagpt_ws --schema",
      "retail --table orders --domain-ids '[5]'",
      "cz-cli analytics-agent datasource load 603 --path",
      "workspace:datagpt_ws/schema:retail/table:orders --domain-ids '[5]'",
      "cz-cli analytics-agent datasource load 603 --workspace datagpt_ws --schema",
      "retail --table-name orders --domain-ids '[5,6]'",
      "以上两种写法等效",
    ],
  },
  {
  ...
  },
  {
    ...
    expectOptions: ["--path", "--table-name", "--table"],
    expectCommands: [
      "Examples:",
      "cz-cli analytics-agent domain table add 27 --datasource-id 603 --workspace",
      "datagpt_ws --schema retail --table orders",
      "cz-cli analytics-agent domain table add 27 --datasource-id 603 --path",
      "workspace:datagpt_ws/schema:retail/table:orders",
      "以上两种写法等效",
    ],
  },
  {

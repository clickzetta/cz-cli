...
export function registerStaticCommands(): void {
  registerCommands([
    ...
    { name: "fs ls", kind: "command", description: "List files or directories",
      ...
      examples: [{ cmd: "cz-cli fs ls volume:user://~/", desc: "List files in your User Volume" }, { cmd: "cz-cli fs ls volume:user://~/images -R", desc: "List a User Volume directory recursively" }] },
    ...
    { name: "fs mb", kind: "command", description: "Create a Named Volume (make bucket)",
      arguments: [{ name: "volume", required: true }],
      examples: [{ cmd: "cz-cli fs mb volume://shared_files", desc: "Create a Named Volume in the current workspace and schema" }] },
    { name: "fs mkdir", kind: "command", description: "Create a directory and missing parents inside an existing filesystem or Volume",
      arguments: [{ name: "path", required: true }],
      examples: [{ cmd: "cz-cli fs mkdir volume://my_volume/data/2026/08", desc: "Create nested directories in an existing Named Volume" }, { cmd: "cz-cli fs mkdir volume:user://~/data/2026/08", desc: "Create nested directories in your User Volume" }] },
    { name: "fs cp", kind: "command", description: "Copy a file or directory",
      ...
      options: [{ flags: "-R, --recursive", required: false, takes_value: false, help: "Copy files in subdirectories" }, { flags: "--overwrite/--no-overwrite", required: false, takes_value: false, help: "Replace existing destination files" }] },
    { name: "fs mv", kind: "command", description: "Move a file or directory",
      arguments: [{ name: "source", required: true }, { name: "destination", required: true }],
      options: [{ flags: "-R, --recursive", required: false, takes_value: false, help: "Move files in subdirectories" }, { flags: "--overwrite/--no-overwrite", required: false, takes_value: false, help: "Replace existing destination files" }] },

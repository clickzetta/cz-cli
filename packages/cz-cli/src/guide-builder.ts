...
export function registerStaticCommands(): void {
  registerCommands([
    ...
    { name: "fs rb", kind: "command", description: "Remove an empty Managed Volume object with --write; does not remove files",
      arguments: [{ name: "volume", required: true }],
      examples: [{ cmd: "cz-cli fs rb czfs:/Volumes/your_workspace/your_schema/your_volume --write", desc: "Drop the Managed Volume object" }] },
    ...
    { name: "fs rm", kind: "command", description: "Remove a file or directory",
      arguments: [{ name: "path", required: true }],
      options: [{ flags: "-R, --recursive", required: false, takes_value: false, help: "Remove directories recursively" }, { flags: "-f, --force", required: false, takes_value: false, help: "Ignore missing paths" }, { flags: "--dry-run", required: false, takes_value: false, help: "Preview without deleting" }, { flags: "--write", required: false, takes_value: false, help: "Confirm removal" }],
      examples: [{ cmd: "cz-cli fs rm czfs:/Volumes/your_workspace/your_schema/your_volume/tmp/data.csv --write", desc: "Remove one file" }, { cmd: "cz-cli fs rm czfs:/Volumes/your_workspace/your_schema/your_volume/tmp/ -R --dry-run", desc: "Preview recursive removal" }] },
    ...
    { name: "table load", kind: "command", description: "Load a czfs Volume path into a table (directory sources must end with /); use SQL for advanced COPY INTO/OVERWRITE cases",
      ...
      options: [{ flags: "--using", required: false, takes_value: true, help: "Input format: csv, parquet, orc, bson (default csv)" }, { flags: "--header", required: false, takes_value: false, help: "Treat the first CSV row as column names" }, { flags: "--write", required: true, takes_value: false, help: "Confirm the load; required as a safety guard" }],

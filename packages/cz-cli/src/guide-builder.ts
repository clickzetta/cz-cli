...
export function registerStaticCommands(): void {
  registerCommands([
    ...
    { name: "fs ls", kind: "command", description: "List files or directories",
      ...
      examples: [{ cmd: "cz-cli fs ls czfs:/", desc: "List Named/External roots and @user/@table entry points" }, { cmd: "cz-cli fs ls czfs:/Volumes/@user/your_workspace/your_user/", desc: "List files in a User Volume" }, { cmd: "cz-cli fs ls czfs:/Volumes/@table/your_workspace/your_schema/your_table/ -R", desc: "List files in a Table Volume recursively" }] },
    ...
    { name: "fs mb", kind: "command", description: "Create a Named Volume only; cannot create User or Table Volumes",
      arguments: [{ name: "volume", required: true }],
      examples: [{ cmd: "cz-cli fs mb czfs:/Volumes/your_workspace/your_schema/your_volume", desc: "Create a Named Volume" }] },
    { name: "fs rb", kind: "command", description: "Remove an empty Named Volume object; does not remove files",
      arguments: [{ name: "volume", required: true }],
      examples: [{ cmd: "cz-cli fs rb czfs:/Volumes/your_workspace/your_schema/your_volume", desc: "Drop the Named Volume object" }] },
    { name: "fs mkdir", kind: "command", description: "Create a directory and missing parents inside an existing filesystem or Volume",
      arguments: [{ name: "path", required: true }],
      examples: [{ cmd: "cz-cli fs mkdir czfs:/Volumes/your_workspace/your_schema/your_volume/data/2026/08", desc: "Create directories in a Named Volume" }, { cmd: "cz-cli fs mkdir czfs:/Volumes/@user/your_workspace/your_user/data/2026/08", desc: "Create directories in a User Volume" }, { cmd: "cz-cli fs mkdir czfs:/Volumes/@table/your_workspace/your_schema/your_table/data/2026/08", desc: "Create directories in a Table Volume" }] },
    ...
    { name: "fs rm", kind: "command", description: "Remove a file or directory",
      arguments: [{ name: "path", required: true }],
      options: [{ flags: "-R, --recursive", required: false, takes_value: false, help: "Remove directories recursively" }, { flags: "-f, --force", required: false, takes_value: false, help: "Ignore missing paths" }, { flags: "--dry-run", required: false, takes_value: false, help: "Preview without deleting" }],

...
The system SHALL list all tables with filtering options using SHOW CATALOG TABLE syntax.
...
The system SHALL show table structure using DESC TABLE syntax including columns, types, and comments.
...
The system SHALL show sample rows from a table.
...
The system SHALL show table statistics using SDK job summary including row count, size, and partition info.
...
The system SHALL show table change history using SHOW TABLES HISTORY syntax.
...
The system SHALL create tables from DDL.
